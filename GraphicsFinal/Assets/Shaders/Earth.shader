        ...
        Pass
        {
            ...
            fixed4 frag(v2f i) : SV_Target
            {
                float3 normalDirection = normalize(i.normal);
                        ...
                        float3 color1 = (diffuseReflection);// *tex2D(_Tex1, i.uv);
         ...
         Pass
        {
            ...
            fixed4 frag(v2f i) : SV_Target
            {
                float3 normalDirection = normalize(i.normal);
                        ...
                        //float3 color =tex2D(_Tex, i.uv); //Texture is not applient on specularReflection
                        float3 color = diffuseReflection*tex2D(_Tex, i.uv); //Texture is not applient on specularReflection
